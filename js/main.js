...
window.addEventListener('load',()=>{loadS();rAll();rPh();try{var _d=JSON.parse(localStorage.getItem('jpe_v9')||'{}');if(!_d.ambientYT){_d.ambientYT="https://youtu.be/MEkaqZecpUQ";localStorage.setItem('jpe_v9',JSON.stringify(_d));}}catch(e){}
  try{
